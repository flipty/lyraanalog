...
<link rel="shortcut icon" href="/favicon2022.ico" />
    <title>Lyra Analog | Pricing</title>
...
<?php include('include-gtm.php');?>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Lyra Pricing
      ...
      <div class="row">
        ...
        <div class="col-lg-8 mb-4">
          <!-- Embedded Google Map -->
          <h3>Please contact MIBS Distro</h3>
          <strong>USA and Canada:</strong><br>
          <a href="mailto:shane@mibsdistro.com">shane@mibsdistro.com</a><br>
          <a href="https://mibsdistro.com" target="_blank">mibsdistro.com</a>
