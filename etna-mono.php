...
<html lang="en">
  ...
  <head>
    ...
    <title>Lyra Analog Etna Mono | Analog LP + MC Cartridge</title>
...
<?php include('include-gtm.php');?>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">ETNA &lambda; Lambda Mono
      ...
      <ol class="breadcrumb" style="background-color: #e5e5e5;">
        ...
        <li class="breadcrumb-item active">Etna &lambda; Lambda Mono</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <!--h3 class="my-3">Description</h3-->
            <p><img class="img-fluid" src="/images/ETNA-LAMBDA-MONO.jpg" style="width:60%; height:auto; padding: 0 25px 15px 0; float:left;" alt="Lyra Etna &lambda;" title="Lyra Etna">This is a special, built-to-order, mono version of Etna &lambda; Lambda for real mono playback of monaural/monophonic (mono) microgroove, vinyl records. It is recommended that the Etna &lambda; Lambda Mono is used with high-gain, low noise phono stages, or alternatively a step-up transformer designed for phono cartridges of 2 - 3 ohms or less.</p>
			...
			<li><strong>Output voltage:</strong> 0.25mV@5cm/sec., 2.4μH inductance</li>
			...
			<li><strong>Recommended tracking force:</strong> 1.65〜1.78g (1.72 g recommended)</li>
			...
			<li><strong>Recommended tonearm:</strong> High-quality pivoted or linear tangential tonearms with rigid bearing(s), adjustable anti-skating force, preferably VTA</li>
		  </ul>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          Lyra Etna &lambda; Lambda SL
		  <a href="etna-sl.php">
            <img class="img-fluid" src="/images/ETNA-LAMBDA-SL.jpg" alt="ETNA SL &lambda;" title="ETNA SL &lambda;">
          </a>
        </div>
